...
# Open the camera
video = cv2.VideoCapture(0)  # Use 0 for the default camera (you may need to change it based on your system)
...
while True:
    ...
    if not ret:
        break  # Break the loop if there's an issue with the camera capture
